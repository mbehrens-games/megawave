...
#define CHANNEL_NUM_OPS 4

typedef struct channel
{
  /* envelope settings */
  unsigned char   ar[CHANNEL_NUM_OPS];  /* 0-31  */
  unsigned char   dr[CHANNEL_NUM_OPS];  /* 0-31  */
  unsigned char   sr[CHANNEL_NUM_OPS];  /* 0-31  */
  unsigned char   rr[CHANNEL_NUM_OPS];  /* 0-15  */
  unsigned char   tl[CHANNEL_NUM_OPS];  /* 0-127 */
